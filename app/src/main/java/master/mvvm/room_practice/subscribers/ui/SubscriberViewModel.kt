package master.mvvm.room_practice.subscribers.ui
...
class SubscriberViewModel(private val repository: SubscriberRepository) : ViewModel()
    ...
    init {
        saveOrUpdateButtonText.value = "Save" /*Text Display in that Button - Dynamic*/
    ...
    /*Make event Class
    * Handle Display Views Toast Message in Main with Observe fun
    *
    * */
